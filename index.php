    ...
    <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
        <div class="container">
            <div class="d-sm-flex flex-sm-row-reverse align-items-center">
                <img src="img/home.jpg" class="img-fluid" width="300" />
                <div>
                    <h1 class="fw-bold display-4">
                        Welcome to V7N Diary!
                    </h1>
                    <h4 class="lead display-6">
                        SETIAP AKU MELIHAT WAJAH IBU, AKU MELIHAT SERIBU ALASAN MENGAPA AKU
                        HARUS SUKSES!
                    </h4>
                    <h6>
...
<!-- article end -->
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/mimpi.jpg" class="d-block w-100" alt="..." />
                    </div>
                    <div class="carousel-item">
                        <img src="img/pengenapa.jpg" class="d-block w-100" alt="..." />
                    </div>
                    <div class="carousel-item">
                        <img src="img/percintaan.jpg" class="d-block w-100" alt="..." />
                    </div>
                    <div class="carousel-item">
    ...
    <section id="aboutme" class="text-center p-5 bg-danger-subtle">
        <div class="container">
            <div class="d-sm-flex align-items-center justify-content-center">
                <div class="p-3">
                    <img src="img/logoku.jpg" class="rounded-circle border shadow" width="300" />
                </div>
                <div class="p-md-5 text-sm-start">
                    <h3 class="lead">A11.2023.14886</h3>
                    <h1 class="fw-bold">Gede Pradistya Evan Aryaputra</h1>
    ...
    <footer id="footer" class="text-center p-5">
        <div>
            <a href="https://www.instagram.com/e.eepan07/"><i class="bi bi-instagram h2 p-2"></i></a>
            <a href=""><i class="bi bi-twitter h2 p-2"></i></a>
            <a href="https://wa.me/+6282133546311"><i class="bi bi-whatsapp h2 p-2"></i></a>
        </div>
        <div>Gede Pradistya Evan Aryaputra &copy; 2023</div>
    </footer>
    <!-- footer end -->
